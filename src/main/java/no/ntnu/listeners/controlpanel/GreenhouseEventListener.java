 ...
 * disappearing, new sensor readings, etc. While the name can be misleading,
 * this interface will actually be usable on the control-panel side, not the
 * greenhouse side. The idea is that a control panel can get events when some
 * new information is received about some changes in a greenhouse.
 */
