...
/**
 * Listener for sensor update events. This will (probably) be usable only on the
 * sensor/actuator node (greenhouse) side, where the real sensor objects are
 * available. The control panel side has only sensor reading values available,
