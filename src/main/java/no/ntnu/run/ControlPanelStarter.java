 ...
 * issues with the debugger (JavaFX modules not found)
 */
public class ControlPanelStarter {
     ...
     *             is "fake", emulate fake events, when it is either something else
     *             or not present, use real socket communication.
     */
