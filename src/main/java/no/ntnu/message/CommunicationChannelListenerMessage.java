...
public class CommunicationChannelListenerMessage implements Message {
    ...
    /**
     * Creates a new CommunicationChannelListenerMessage with the specified communication channel listener.
     *
     * @param communicationChannelListener The communication channel listener to be associated with this message.
     */
