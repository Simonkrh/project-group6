...
/**
 * Represents a command to turn on a specific actuator.
 */
public class TurnOnActuatorCommand extends Command {
    ...
    /**
     * Creates a new instance of the TurnOnActuatorCommand class.
     *
    ...
    public Message execute(ControlPanelLogic logic) {
        try {
            ...
            logic.getGreenhouseSimulator().changeActuatorState(nodeId, actuatorId, true);
