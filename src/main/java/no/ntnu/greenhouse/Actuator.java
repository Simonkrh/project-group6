 ...
 * impact on the sensors attached to this same node.
 */
public class Actuator {
     ...
     *                       reading when the actuator is active. For example, if
     *                       this value is 2.0 and the sensorType is "temperature",
     *                       this means that "activating this actuator will increase
     *                       the readings of temperature sensors attached to the
     ...
     *
     * @return The type of the actuator as a String. This type represents the
     *         category or functionality of the actuator, such as "heater",
     *         "cooler", or "light".
     */
    ...
    public Actuator createClone() {
        ...
        // long as we don't modify the impacts AFTER creating the template
        a.impacts = impacts;
        return a;
    }
    ...
    public String toString() {
        return "Actuator{" + "type='" + type + '\'' + ", on=" + on + '}';
    }
     ...
     *
     * @return The node ID indicating the specific sensor/actuator node in the
     *         network where this actuator is located.
     */
