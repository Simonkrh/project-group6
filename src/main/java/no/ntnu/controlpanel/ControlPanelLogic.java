 ...
 * send commands and receive events. It supports listeners who will be notified
 * on changes (for example, a new node is added to the network, or a new sensor
 * reading is received). Note: this class may look like unnecessary forwarding
 * of events to the GUI. In real projects (read: "big projects") this logic
 * class may do some "real processing" - such as storing events in a database,
 * doing some checks, sending emails, notifications, etc. Such things should
 * never be placed inside a GUI class (JavaFX classes). Therefore, we use proper
 * structure here, even though you may have no real control-panel logic in your
 * projects.
 */
public class ControlPanelLogic implements GreenhouseEventListener, ActuatorListener,
    ...
    /**
     * Get the communication channel listener instance associated with this control
     * panel.
     *
    ...
    public void onNodeRemoved(int nodeId) {
        ...
        Logger.info("Node " + nodeId + " is removed");
    }
